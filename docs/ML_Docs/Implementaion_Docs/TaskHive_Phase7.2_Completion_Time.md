...
**Generation logic (`training/training_generator/generate_completion_data.py`):**
...
**Train script:** `training/scripts/train_completion.py`
**Output:** `inference-server/artifacts/completion_model.pkl`
...
│
└── inference-server/
    ├── main.py                          # app setup, include completion router
    ├── artifacts/
    │   └── completion_model.pkl         # GENERATED by training
    ├── api/
    │   ├── routes/
