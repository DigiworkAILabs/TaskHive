...
**Generation logic (`training/training_generator/generate_productivity_data.py`):**
...
**Train script:** `training/scripts/train_productivity.py`
**Output:** `inference-server/artifacts/productivity_model.pkl`
...
│
└── inference-server/
    ├── main.py                          # app setup, include productivity router
    ├── artifacts/
    │   └── productivity_model.pkl       # GENERATED by training
    ├── api/
    │   ├── routes/
