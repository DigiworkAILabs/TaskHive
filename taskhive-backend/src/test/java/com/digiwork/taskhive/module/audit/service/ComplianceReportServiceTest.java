...
class ComplianceReportServiceTest {
        ...
        void getUserAccessReport() {
                ...
                when(auditLogRepository.findByActionInAndDateRange(any(), eq(startDate), eq(endDate),
                                any(PageRequest.class)))
                                .thenReturn(page);

                PageResponse<AuditLogResponse> response = complianceReportService.getUserAccessReport(startDate,
                                endDate, 0, 10);
        ...
        void getDataModificationReport() {
                ...
                PageResponse<AuditLogResponse> response = complianceReportService.getDataModificationReport(startDate,
                                endDate, 0, 10);
        ...
        void getSecurityIncidentReport() {
                ...
                PageResponse<SecurityEventResponse> response = complianceReportService
                                .getSecurityIncidentReport(startDate, endDate, 0, 10);
