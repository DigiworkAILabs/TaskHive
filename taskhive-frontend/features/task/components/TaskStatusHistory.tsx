                            ...
                            <div key={entry.id} style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                                ...
                                <div
                                    style={{
                                        ...
                                        backgroundColor: '#111111', border: '2px solid #2a2a2a',
                                ...
                                <div style={{ flex: 1, paddingBottom: '4px' }}>
                                    ...
                                    {entry.comment && (
                                        <div style={{ marginTop: '6px', padding: '8px 12px', borderRadius: '8px', backgroundColor: '#111111', border: '1px solid #2a2a2a', color: '#a1a1aa', fontSize: '13px', fontStyle: 'italic' }}>
                                            "{entry.comment}"
                                        </div>
                                    )}
                                </div>
